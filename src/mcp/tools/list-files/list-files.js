...
import { buildDatasetContext, resolveDatasetBucket } from '../../utils/utils.js';
...
export default class ListFilesTool extends BaseTool {
  ...
  async handler({ prefix = '', maxResults = 100, endpoint, bucket }) {
    const fromDataset = bucket || S3_BUCKET ? {} : resolveDatasetBucket(this.config.datasets, prefix);
